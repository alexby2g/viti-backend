...
use App\Models\{Aplicacion,CatalogoAplicacion,ElectrofrioCliente,Empresa,PlanViti,Usuario};
...
trait CreatesVitiTenants
{
    protected function createTenant(string $suffix, string $role = 'propietario', ?array $permissions = null): array
    {
        ...
        $user = Usuario::create([
            ...
            'telefono' => '7'.substr(str_pad((string) abs(crc32('phone-'.$suffix)), 8, '0', STR_PAD_LEFT), 0, 8),
            'password' => 'Prueba1234',
            'rol' => 'cliente',
            'estado' => 'activo',
        ]);
