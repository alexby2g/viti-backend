...
class FeatureGateService
{
    ...
    public function modulesForApp(Aplicacion $application): ?array
    {
        ...
        $selected = $this->normalize((array) ($config['modulos'] ?? $application->modulos ?? []));
    ...
    {
        abort_unless($this->hasModule($empresa, $module), 403, 'Este módulo no forma parte del plan VITI asignado a tu negocio.');
    }
