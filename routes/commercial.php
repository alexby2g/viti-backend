...
use App\Http\Controllers\{AgrSituationController,ApplicationAccessController,AplicacionController,BillingController,ChatDocumentController,ClientBillingController,ClientPaymentController,ClientPortalController,PaymentReviewController,SaasController};
...
Route::middleware(['auth:sanctum','throttle:api'])->group(function (): void {
    ...
    Route::middleware('platform_admin')->group(function (): void {
        ...
        Route::get('aplicaciones/{aplicacion}/acceso', [ApplicationAccessController::class,'status']);
        Route::post('aplicaciones/{aplicacion}/acceso/bloquear', [ApplicationAccessController::class,'block']);
        Route::post('aplicaciones/{aplicacion}/acceso/desbloquear', [ApplicationAccessController::class,'unblock']);
