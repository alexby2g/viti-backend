...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;margin:0 auto;background:#15151b;border:1px solid #2d2d39;border-radius:18px;overflow:hidden">
    <tr><td style="padding:28px 30px 12px">
        ...
        <p style="margin:0;color:#b8b8c2;line-height:1.6">Hola {{ $cliente?->nombre ?? 'cliente' }}, AGR Studio revisó la solicitud{{ $empresa?->nombre_comercial ? ' de '.$empresa->nombre_comercial : '' }} y habilitó tu registro seguro en VITI.</p>
    </td></tr>
    ...
    <tr><td style="padding:0 30px 24px;color:#b8b8c2;line-height:1.6;font-size:14px">
        <p>Este enlace es personal, puede utilizarse una sola vez y vence {{ $expiraAt ? $expiraAt->timezone(config('app.timezone'))->format('d/m/Y H:i') : 'según la vigencia indicada por AGR Studio' }}.</p>
        <p style="margin-bottom:0">Si no solicitaste este acceso, puedes ignorar este mensaje. AGR Studio nunca te enviará una contraseña creada por nosotros.</p>
    </td></tr>
    <tr><td style="padding:18px 30px;border-top:1px solid #2d2d39;color:#777786;font-size:12px">VITI · Plataforma de proyectos y soluciones digitales administrada por AGR Studio.</td></tr>
</table>
</body>
</html>
